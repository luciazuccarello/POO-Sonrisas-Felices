...
public abstract class Paciente implements Comparable<Paciente> {
    ...
    private src.model.Domicilio domicilio;

    public Paciente(Integer id, String nombre, String apellido, String dni, String mail, Date fechaAlta, src.model.Domicilio domicilio) {}
