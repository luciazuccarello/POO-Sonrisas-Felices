...
public class Turno {
    ...
    public Turno(Integer id, Paciente paciente, Odontologo odontologo, Date fecha, Date hora, EstadoTurno estado, double montoFinal) {
        this.id = id;
    ...
    public void actualizarMonto(){
        //se llama al comportamiento polimorfico del paciente
