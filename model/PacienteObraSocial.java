...
public class PacienteObraSocial extends src.model.Paciente {
    private String nombreObraSocial;
    private int numeroAfiliado;

    public PacienteObraSocial (Integer id, String nombre, String apellido, String dni, String mail, Date fechaAlta, src.model.Domicilio domicilio, String nombreObraSocial, int numeroAfiliado) {
